...
const ROOM_TOPIC = "musabaka_adl_fa180cab_room1"; 
...
function handleIncomingQuestion(data) {
  ...
  // Make sure we are on the participant screen
  goto('screen-participant');
  // Show the question sub-view
...
async function sendAnswer() {
  const q = QUESTIONS[app.currentCat] ? QUESTIONS[app.currentCat][app.currentQIdx] : {type:'open'};
  let ans = "";
