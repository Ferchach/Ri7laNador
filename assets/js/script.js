// ══ CONFIGURATION PURE NTFY (ULTRA RAPIDE & LÉGER) ════════════
let ROOM_CODE = localStorage.getItem('musabaka_room_code') || "";
const SYNC_BASE = "https://ntfy.sh/musabaka_adl_v5_"; 
...
async function saveRoomState() {
  if (!ROOM_CODE) return;
  // Payload ultra-léger (sans le gameLog qui faisait crasher ntfy à cause de la taille)
  const syncState = {
    teams: app.teams,
