...
// ══ SHARED STATE (simulates server via global for same-device use; can be replaced with WebSocket) ══
const shared = {
...
function launchQuestion() {
  ...
  shared.cat = app.currentCat;
  shared.qIndex = app.currentQIdx;
  shared.qText = q.q;
  shared.qType = q.type;
  shared.opts = q.type === 'mcq' ? q.opts : (q.type === 'mimes' ? q.words : []);
  shared.timerStart = now;
  shared.duration = dur;
  shared.answers = {};
